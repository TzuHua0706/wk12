  ...
  renderButton() {
    ...
    return (
      <Button
        ...
        buttonStyle={{ borderRadius:3, marginTop:'-3%',}}
      />
    );
  }
  ...
  render() {
    return (
      <View style={styles.all}>
        <Image source = {require('./img.png')} style={{marginTop:'13%',}}/>
        ...
        <View style={styles.tit}>
          ...
          <FormValidationMessage style={{height:'10%',}}>{this.state.error}</FormValidationMessage>
          <Button
